...
API_URL = 'https://renm6rzank.execute-api.us-east-1.amazonaws.com/visitorCounter'
...
def test_visitor_counter_system():
    ...
    assert response.status_code == 200, f"Expected status code 200, but recieved {response.status_code}"
